...
{
       0,    35,    35,    36,    39,    40,    43,    44,    45,    50,
      56,    61,    67,    73,    78,    85,    92,    98,   104,   109,
     115,   119,   123,   130,   134,   139,   146,   152,   157,   162,
     168,   174,   180,   186,   191,   198,   201
};
#endif
...
{
  "$end", "error", "$undefined", "LS", "DEFPROMPT", "CD", "LISTJOBS",
  "BYE", "NEWLINE", "ASSIGNTO", "RUN", "EQUAL", "COMMENT", "BG", "KEYWORD",
  "VARIABLE", "STRING", "WORD", "META", "$accept", "program", "prompts",
  "prompt", "command", "arg", "arglist", YY_NULLPTR
};
#endif
...
{
      20,     0,   -10,    -1,    -2,    -2,   -13,     8,    -2,   -13,
      -2,    27,   -13,   -13,    11,    41,   -13,    58,    -2,    30,
     -13,    -2,    -2,    -2,   -13,   -13,   -13,   -13,    -2,    31,
...
{
       0,     0,     0,     0,    23,    20,     9,     0,     0,    33,
      34,    32,    31,    30,     0,     0,     4,     0,    36,    29,
       8,    13,    10,    18,    34,    32,    24,    21,     0,    28,
      22,     0,     1,     5,     6,     7,    35,    27,    12,    11,
      19,    25,    26,    17,    16,    14,    15
};
...
{
      26,    27,    29,    33,    30,    35,    21,    22,    20,     9,
      24,    32,    36,    25,    12,    13,    23,    38,    39,    40,
      -3,     1,    41,    28,     2,     3,     4,     5,     6,     7,
       8,     9,    10,    43,    44,    11,    12,    13,    31,    45,
      46,    -2,     1,    37,    42,     2,     3,     4,     5,     6,
       7,     8,     9,    10,     0,     0,    11,    12,    13,     1,
       0,     0,     2,     3,     4,     5,    34,     7,     8,     9,
      10,     0,     0,    11,    12,    13
};

static const yytype_int8 yycheck[] =
{
       4,     5,     8,    15,    10,    17,    16,    17,     8,    11,
      12,     0,    18,    15,    16,    17,    17,    21,    22,    23,
       0,     1,    28,    15,     4,     5,     6,     7,     8,     9,
      10,    11,    12,    16,    17,    15,    16,    17,    11,    43,
      44,     0,     1,    13,    13,     4,     5,     6,     7,     8,
...
static const yytype_uint8 yystos[] =
{
      ...
      12,    15,    16,    17,    20,    21,    22,    23,    24,    25,
       8,    16,    17,    17,    12,    15,    24,    24,    15,    25,
      25,    11,     0,    22,     8,    22,    25,    13,    24,    24,
      24,    25,    13,    16,    17,    24,    24
};
...
#line 56 "parser.y" /* yacc.c:1646  */
    {
					addToTokenList("word", (yyvsp[0].word), "anytext"); 
...
#line 61 "parser.y" /* yacc.c:1646  */
    {
					...
					addToTokenList("word", (yyvsp[-1].word), "anytext"); 
					addToTokenList("keyword", "defprompt", "defprompt");
					printf("Error: Prompt must be a string; e.g. defprompt \"prompt > \"\n");
				}
...
#line 67 "parser.y" /* yacc.c:1646  */
    {
					argcount = 1; //make sure the usage is never 'cmd'
					addToTokenList("string", (yyvsp[-1].string), "anytext");
					addToTokenList("keyword", "defprompt", "defprompt");
					printf("Error: Prompt must be a string; e.g. defprompt \"prompt > \"\n");
				}
...
#line 73 "parser.y" /* yacc.c:1646  */
    {
                                        addToTokenList("string", (yyvsp[0].string), "anytext");
                                        addToTokenList("keyword", "defprompt", "defprompt");
					builtInCmd(DEFPROMPT, (yyvsp[0].string), NULL);
                                }
...
#line 78 "parser.y" /* yacc.c:1646  */
    {
					argcount = 1; //make sure the usage is never cmd
					addToTokenList("string", (yyvsp[-1].string), "variable_def"); 
					addToTokenList("metachar", "=", "assignment");
                                        addToTokenList("word", (yyvsp[-3].variable), "variable_name");
...
#line 85 "parser.y" /* yacc.c:1646  */
    {
					argcount = 1; //make sure the usage is never cmd
					addToTokenList("word", (yyvsp[-1].word), "variable_def");
                                        addToTokenList("metachar", "=", "assignment");
                                        addToTokenList("word", (yyvsp[-3].variable), "variable_name");
                                        printf("Variable assignment should be of the form Variable = Definiton\n");
                                }
...
#line 92 "parser.y" /* yacc.c:1646  */
    {
					addToTokenList("word", (yyvsp[0].word), "variable_def");
					addToTokenList("metachar", "=", "assignment");
					addToTokenList("word", (yyvsp[-2].variable), "variable_name");
					builtInCmd(EQUAL, (yyvsp[0].word), (yyvsp[-2].variable));
				}
...
#line 98 "parser.y" /* yacc.c:1646  */
    {
                                        addToTokenList("string", (yyvsp[0].string), "variable_def");
                                        addToTokenList("metachar", "=", "assignment");
                                        addToTokenList("word", (yyvsp[-2].variable), "variable_name");
                                        builtInCmd(EQUAL, (yyvsp[0].string), (yyvsp[-2].variable));
                                }
...
#line 104 "parser.y" /* yacc.c:1646  */
    {
					addToTokenList("word", (yyvsp[0].word), "directory");
					addToTokenList("keyword", "cd", "change directory");
					builtInCmd(CD, (yyvsp[0].word), NULL);
				}
...
#line 109 "parser.y" /* yacc.c:1646  */
    {
					argcount = 1; //make sure the usage is never cmd
					addToTokenList("word", (yyvsp[-1].word), "directory");
                                        addToTokenList("keyword", "cd", "change directory");
...
#line 139 "parser.y" /* yacc.c:1646  */
    {
					argcount = 1; 
				        addToTokenList("variable", (yyvsp[-1].variable), "destination");
				        addToTokenList("keyword", "assignto", "assignto");
				        assignCommand((yyvsp[-1].variable), (yyvsp[0].arg_list));
   				}
...
#line 168 "parser.y" /* yacc.c:1646  */
    {
					...
					addToTokenList("word", (yyvsp[0].word), argtoken);
					argcount++;
					(yyval.string) = (yyvsp[0].word);
				}
...
#line 174 "parser.y" /* yacc.c:1646  */
    {
			 		sprintf(argtoken, "arg %d", argcount);
                                        addToTokenList("string", (yyvsp[0].string), argtoken);
                                        argcount++;
...
#line 180 "parser.y" /* yacc.c:1646  */
    {
					sprintf(argtoken, "arg %d", argcount);
					addToTokenList("variable", (yyvsp[0].variable), argtoken);
					argcount++;
...
#line 198 "parser.y" /* yacc.c:1646  */
    {
					(yyval.arg_list) = constructArglist((yyvsp[-1].string), (yyvsp[0].arg_list));
				}
...
#line 201 "parser.y" /* yacc.c:1646  */
    {
					(yyval.arg_list) = constructArglist((yyvsp[0].string), NULL);
				}
